...
<head>
    ...
    <style>
        ...
        white-space: nowrap;
        width: fit-content;
        animation: scrollf 24s linear infinite; /* Adjust the animation duration */
        }
        .marqueea {
        white-space: nowrap;
        width: fit-content;
        animation: scrolla 24s linear infinite; /* Adjust the animation duration */
        }
...
<script>
const frenchMarquee = document.getElementById("frenchMarquee");
const arabicMarquee = document.getElementById("arabicMarquee");

frenchMarquee.addEventListener("animationiteration", () => {
  arabicMarquee.style.display = "block";
  frenchMarquee.style.display = "none";
});

arabicMarquee.addEventListener("animationiteration", () => {
    frenchMarquee.style.display = "block";
    arabicMarquee.style.display = "none";
});

// Start the initial marquee
frenchMarquee.style.display = "block";
